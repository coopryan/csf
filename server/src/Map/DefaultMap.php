...
final class DefaultMap extends Map
{
    ...
    public function __construct()
    {
        ...
        if (true) {
            ...
            // b window access
            $add(
                new Point(3832, 1116, 12223),
                new Point(3832, 905, 11867),
                new Point(4402, 905, 11867),
                new Point(4402, 1116, 12223),
            );
            $add(
        ...
        if (true) {
            ...
            // lower tunnel
            $add(
                new Point(4628, 464, 7796),
                new Point(3996, 464, 7796),
                new Point(3996, 585, 7674),
                new Point(4628, 585, 7674),
            );
            $add(
                new Point(4628, 585, 7674),
                new Point(3996, 585, 7674),
                new Point(3996, 585, 7214),
                new Point(4628, 585, 7214),
            );
            $add(
                new Point(4237, 575, 7214),
                new Point(4237, 575, 7886),
                new Point(3858, 894, 7886),
            ...
            $add(
                ...
                new Point(4616, 406, 7484),
                new Point(4616, 1697, 7484),
            );
            $add(
                new Point(4616, 1697, 7484),
                new Point(4616, 406, 7484),
                new Point(4579, 406, 7484),
                new Point(4579, 1697, 7484),
            );
            $add(
                new Point(4579, 1697, 7484),
                new Point(4579, 406, 7484),
                new Point(4579, 406, 7333),
                new Point(4579, 1697, 7333),
            );
            $add(
                new Point(4579, 1697, 7333),
                new Point(4579, 406, 7333),
                new Point(4488, 406, 7333),
                new Point(4488, 1697, 7333),
            );
            $add(
                new Point(4488, 1697, 7333),
                new Point(4488, 406, 7333),
                new Point(4488, 406, 7217),
                new Point(4488, 1697, 7217),
            );
            $add(
                new Point(4488, 1697, 7217),
                new Point(4488, 406, 7217),
                new Point(3827, 406, 7217),
                new Point(3827, 1697, 7217),
            );
            $add(
                new Point(4616, 406, 8066),
                new Point(4616, 1697, 8066),
        ...
        if (true) {
            ...
            $add(
                new Point(3856, 889, 7223),
                new Point(3856, 1477, 7223),
                new Point(3856, 1477, 7184),
                new Point(3856, 889, 7184),
            );
        }
